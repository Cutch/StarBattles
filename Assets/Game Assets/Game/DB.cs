...
namespace StarBattles
{
    public class DB
    {
        ...
        static DB()
        {
            ...
            db.Add(new ShipBean("Std. Rotor Jets", 300, 0.5, 0, 0, 10, 0, 10, 0, 0.0, true, 5, "PrefabPieces/ShipItems/RotorJets", "Images/rotorJets_1", new Vector3[1] { new Vector3(0, 1, 0) }));
            db.Add(new ShipBean("Slvr. Rotor Jets", 400, 0.75, 0, 0, 15, 0, 20, 0, 0.0, true, 5, "PrefabPieces/ShipItems/RotorJetsSilver", "Images/rotorJetsP_1", new Vector3[1] { new Vector3(0, 1, 0) }));

...
namespace StarBattles
{
    public class JoinPoint : MonoBehaviour, IPointerClickHandler
    {
        ...
        Image image;
        int id;
        Color selectedColour = new Color(255, 255, 0, 255);
        Color unselectedColour = new Color(255, 255, 255, 255);
        Color joinColour = new Color(255, 0, 79, 255);

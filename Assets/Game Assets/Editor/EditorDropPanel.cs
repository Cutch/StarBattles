...
namespace StarBattles
{
    public class EditorDropPanel : MonoBehaviour, IDropHandler, IPointerClickHandler
    {
        ...
        public EditorPiece selectedEditorPiece = null;
        ...
        void Update()
        {
            if (acceptInput && selectedLinkPiece != null && selectedLinkPiece.fireable)
            {
                if (Input.GetKey(KeyCode.Escape)) // Escape
                {
                    Text dd = keyInput.GetComponent<Text>();
                    dd.text = "None";
                    selectedLinkPiece.setFireKey(0, (char)0);
                ...
                if (Input.inputString != "")
                {
                    ...
                    Text dd = keyInput.GetComponent<Text>();
                    dd.text = KeyNames.charToName(c);
                    selectedLinkPiece.setFireKey(0, c);
                    selectedLinkPiece.setLinkColour();
                }
            }
        }
        void Start()
        {
            ...
            editorInnerScroll = GameObject.Find("EditorInnerScroll View");
            editorInnerScroll.SetActive(true);
            linkerInnerScroll = GameObject.Find("LinkerInnerScroll View");
        ...
        public void validateSave()
        {
            ...
            if (text != "")
            {
                ...
                SaveLoadShip.Save(new StarBattles.Ship(text, editorPiecesConvert));
                savePanel.SetActive(false);
            }
        }
        ...
        {
            if (selectedLine != null && selectedLine != sel)
        ...
        public void OnPointerClick(PointerEventData eventData)
        {
            ...
            keyInput.GetComponent<Text>().text = "None";
            instructionText.GetComponent<Text>().text = "Click a highlighted object";
            keyInput.SetActive(false);
            keyText.SetActive(false);
        ...
        public void editorPieceClicked(EditorPiece ep)
        {
            if (acceptInput)
            {
                ...
                keyInput.GetComponent<Text>().text = l.Count == 1 ? l[0] : "None";
